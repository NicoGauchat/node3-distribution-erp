...
Objetivo: Que la demo no tenga huecos evidentes que frenen la venta. Esfuerzo: ~1-2 semanas
...
Objetivo: Producto funcional para los primeros 5-10 clientes pagando. Esfuerzo: ~2-3 meses de desarrollo
...
Fase 2 — V1 completa
Objetivo: Producto competitivo con el mercado. Poder competir contra Flexxus, Natural Software, etc. Esfuerzo: ~3-4 meses adicionales
...
Fase 3 — V2 escala
Objetivo: Diferenciación competitiva. Features que no tiene la competencia local. Esfuerzo: 6-12 meses, desarrollo continuo
...
(
+
20),PortalB2B(+35), App preventa (+$15/vendedor)
